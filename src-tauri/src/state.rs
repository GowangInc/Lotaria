...
pub static PROVIDER_DEFINITIONS: &[ProviderDefStatic] = &[
    ...
    ProviderDefStatic {
        key: "foxcode",
        name: "FoxCode (Multi-Provider Proxy)",
        env_var: "FOXCODE_API_KEY",
        docs_url: "https://code.newcli.com",
        vision_models: &[
            // Gemini models (https://code.newcli.com/gemini)
            "gemini-3-pro",
            "gemini-3-pro-high",
            "gemini-3-pro-preview",
            "gemini-3-flash",
            ...
            "gemini-2.5-flash",
            "gemini-2.5-flash-lite",
            // Codex models (https://code.newcli.com/codex/v1)
            "gpt-5.3-codex",
            "gpt-5.2",
            "gpt-5.2-codex",
            "gpt-5.1",
            ...
            "gpt-5",
            "gpt-5-codex",
            // Anthropic models (https://code.newcli.com/claude/aws)
            "claude-sonnet-4-6",
            "claude-opus-4-6",
            "claude-opus-4-5",
        ...
        live_voices: &[],
        recommended: false,
        cost_note: "$ — ¥0.03-0.35/M tokens (vision only)",
        requires_tts_provider: true,
    },
];
